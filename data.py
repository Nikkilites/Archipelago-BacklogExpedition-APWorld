extra_regions = ["Desert", "Tropical", "Volcanic", "Polar", "Gemstone", "Mountainous", "Cherry Forest", "Swamp", "Jungle", "Pine Forest", "Orchard", "Plains", "Glacier Caves", "Tar Pits"]
...
mcguffins = ["Desert Bracelet", "Tropical Amulet", "Volcanic Jewel", "Polar Shard", "Gemstone Heirloom", "Mountainous Rock"]