...
1. Simply connect to the server on the webpage and log in
2. Enjoy!
...
3. Connect to the server within the game
4. Please note that, In this version you navigate with typing only
4. Enjoy!
